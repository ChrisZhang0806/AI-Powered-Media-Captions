...
export const MediaPlayer: React.FC<MediaPlayerProps> = ({
    ...
    return (
        <div className={`rounded-xl overflow-hidden shadow-lg h-64 ring-1 ring-slate-900/5 shrink-0 relative flex flex-col items-center justify-center ${isAudio ? 'bg-gradient-to-br from-slate-800 to-slate-950' : 'bg-black'}`}>
            {isAudio ? (
